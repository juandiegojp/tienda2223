            ...
            <?php if (!$carrito->vacio()) : ?>
                ...
                <div class="overflow-y-auto py-4 px-3 bg-gray-50 rounded dark:bg-gray-800">
                            ...
                            <tbody>
                                <?php foreach ($carrito->articulos() as $id => $pareja) : ?>
                                    ...
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                        <td class="py-2 px-3"><?= $articulo->descripcion ?></td>
                    ...
                    <div>
                        ...
                        <a href="/comprar.php" class="focus:outline-none text-white bg-green-800 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-900">
                            Comprar
                        </a>
                    </div>
                </aside>
